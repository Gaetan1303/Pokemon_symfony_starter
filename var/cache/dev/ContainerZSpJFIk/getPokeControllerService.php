 ...
 */
class getPokeControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\PokeController' shared autowired service.
     *
     * @return \App\Controller\PokeController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/PokeController.php';

        $container->services['App\\Controller\\PokeController'] = $instance = new \App\Controller\PokeController();
        ...
        ]))->withContext('App\\Controller\\PokeController', $container));
