...
/* poke/add.html.twig */
class __TwigTemplate_c2eb884b9405248105bdc03b410338fa extends Template
{
    ...
    <a href=\"{{ path('app_index') }}\" class=\"bg-green-500 hover:bg-green-600 px-6 py-2 rounded text-lg transition-colors\">Accueil</a>
     ...
     {{ form_start(form) }}
        ...
        <div class=\"flex items-center gap-4\">
            ...
            {{  form_widget(form.parcourir, { attr: { class : \"bg-green-500 hover:bg-green-600 px-6 py-2 rounded text-lg transition-colors cursor-pointer\"}}) }}
        </div>
